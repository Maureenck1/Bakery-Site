...
<body id="details-body">
    ...
    <div class="container container-main">
        <div id="cake-details-div">
            <h1 id="cake-name" style="color:rgb(240,12,245);"><span style="text-decoration: underline;">Cake name Details.</span></h1><img src="assets/img/wedding-cake-clipping-path-picture-id171336145.jpg" class="rounded-circle img-fluid" id="img-size" /></div>
        <div id="description" style="margin:20px;">
            <p>This type of cake is best suited for the following accasions :</p>
            <p style="margin:0px 0px 0px;">Weddings&nbsp;</p>
            <p style="margin:0px 0px 0px;">Birthdays&nbsp;</p>
            <p style="margin:0px 0px 0px;">Aneversaries</p>
            <p style="margin:0px 0px 0px;">Special Occasions.</p>
        </div>
        <div id="ingridients-div">
            <h2 id="ingidients-heading">Ingridients.</h2>
            <ul id="list" style="font-size:20px;">
                <li>Flour &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</li>
                <li>Sugar &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</li>
                <li>Yeast &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</li>
                <li>Milk &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;</li>
        ...
        <div class="mother-div2" style="font-size:20px;">
            <h1 id="price">Pricing Per Killorgram .</h1>
            <div class="mother-div">
                <h2>1. One Kg &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<span class="price-span">Ksh 300/=</span></h2>
                <div class="order-div"><a class="btn btn-primary btn-block btn-lg order-button" role="button" href="#" style="background-color:rgb(240,12,245);"><strong>Oder Now !!!!!!</strong></a></div>
                <h2>2. Two Kgs &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<span class="price-span">Ksh 600/=</span></h2>
                <div class="order-div"><a class="btn btn-primary btn-block btn-lg order-button" role="button" href="#" style="background-color:rgb(240,12,245);"><strong>Oder Now !!!!!!</strong></a></div>
                <h2>3. Three Kgs &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<span class="price-span">Ksh 900/=</span></h2>
                <div class="order-div"><a class="btn btn-primary btn-block btn-lg order-button" role="button" href="#" style="background-color:rgb(240,12,245);"><strong>Oder Now !!!!!!</strong></a></div>
                <h2>4. Four Kgs &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;<span class="price-span">Ksh 1200/=</span></h2>
                <div class="order-div"><a class="btn btn-primary btn-block btn-lg order-button" role="button" href="#" style="background-color:rgb(240,12,245);"><strong>Oder Now !!!!!!</strong></a></div>
            </div>
        </div>
    </div>
